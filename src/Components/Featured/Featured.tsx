                ...
                <Box p={"15px"}
                    ...
                    <Flex>
                        <Flex alignItems={"center"}>
                            <Text className="title" fontSize={"1.75rem"} fontWeight={"500"} lineHeight="1.2" margin="0 30px 0 0" paddingRight="30px" borderRight="1px solid #eee">Book with Confidence</Text>
                        </Flex>
                        <Box>
